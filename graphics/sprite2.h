...
public:
    ...
    inline void SetXPos(float x)              { fxPos = x; }
    inline void SetYPos(float y)              { fyPos = y; }
    inline void SetXYPos(float x, float y)    { fxPos = x; fyPos = y; }
    inline void SetRotation(float theta)      { fRotation = theta; }
    inline void SetRotationX(float rx)        { fRotationX = rx; }
    inline void SetRotationY(float ry)        { fRotationY = ry; }
    inline void SetRotationXY(float rx, float ry) { fRotationX = rx; fRotationY = ry; }
    inline void SetScale(float s)             { fScale = s; }
    inline void SetOrientation(int o)         { iOrientation = o; }

    inline void MoveX(float dx)               { fxPos += dx; }
    inline void MoveY(float dy)               { fyPos += dy; }
    inline void MoveXY(float dx, float dy)    { fxPos += dx; fyPos += dy; }
    inline void Rotate(float theta)           { fRotation += theta; }
    ...
    HRESULT Draw(float fX, float fY, float fRotation,
