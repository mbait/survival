...
public:
	...
	inline bool IsAnimated() const {return bAnimationActive;}
	...
	void StartAnimation();
	inline void ResetAnimation() {counter = 0; cur_frame = 0;}
	inline void StopAnimation() {bAnimationActive = false;}
	inline void SetCurrentFrame(DWORD dwFrameIndex) {cur_frame = dwFrameIndex;}
	inline void SetAnimationTime(DWORD dwTime) {animation.dwTime = dwTime;}
